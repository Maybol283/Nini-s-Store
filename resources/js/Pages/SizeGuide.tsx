...
const SizeGuide = () => {
    return (
        <div className="bg-cream flex flex-col items-center justify-start min-h-screen min-w-full pt-8 xl:pt-16 text-green">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:gap-16 w-full max-w-7xl ">
                {sizeGuideData.map((table, tableIndex) => (
                    <div key={tableIndex}>
                        ...
                        <table className="text-2xl xl:text-3xl w-full border-collapse border border-gray-300  text-outline-green text-white">
                            <thead>
